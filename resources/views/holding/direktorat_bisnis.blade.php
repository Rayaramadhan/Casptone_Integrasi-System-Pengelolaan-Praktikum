        ...
        <section class="flex-1 p-8">
            <div class="w-full max-w-7xl mx-auto flex justify-between items-center mb-6">
                <div class="flex items-center gap-2">
                    <h1 class="text-2xl font-bold text-gray-800">Direktorat Bisnis</h1>
                    <img src="/images/Holding/direktoratbisnis/DirektoratBisnis.png" alt="Logo Direktorat" class="h-8 w-8">
                </div>
            ...
            <div class="w-full max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <div class="custom-card flex flex-col items-center p-6">
                    <img src="/images/holding/direktoratbisnis/SummaryBisnis.png" alt="Summary Kinerja Icon" class="h-20 w-20 mb-4">
                    <h2 class="text-lg font-semibold text-gray-700">Summary Kinerja Direktorat Bisnis</h2>
                </div>

                <div class="custom-card flex flex-col items-center p-6">
                    <img src="/images/holding/direktoratbisnis/Pemasaran.png" alt="Pemasaran Icon" class="h-20 w-20 mb-4">
                    <h2 class="text-lg font-semibold text-gray-700">Sekretariat Perusahaan</h2>
                </div>

                <div class="custom-card flex flex-col items-center p-6">
                    <img src="/images/holding/direktoratbisnis/transformasi.png" alt="transformasi Icon" class="h-20 w-20 mb-4">
                    <h2 class="text-lg font-semibold text-gray-700">Tranformasi dan Sustainability</h2>
                </div>

                <div class="custom-card flex flex-col items-center p-6">
                    <img src="/images/holding/direktoratbisnis/digitaltransformasi.png" alt="digital Icon" class="h-20 w-20 mb-4">
                    <h2 class="text-lg font-semibold text-gray-700">Digital Transformation Office</h2>
                </div>
            </div>
