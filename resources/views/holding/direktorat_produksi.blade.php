    ...
    <main class="flex-1 flex flex-col">
        <section class="relative w-full h-[30vh] bg-cover bg-center" style="background-image: url('/images/Holding/direktoratbisnis/headerBisnis.png');">
            ...
            <div class="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
                <h2 class="text-4xl font-extrabold drop-shadow-md">Dashboard Analitik Direktorat Produksi & Pengembangan</h2>
            </div>
        </section>
        ...
        <section class="flex-1 p-8">
            <div class="w-full max-w-7xl mx-auto flex justify-between items-center mb-6">
                <div class="flex items-center gap-2">
                    <h1 class="text-2xl font-bold text-gray-800">Direktorat Produksi & Pengembangan</h1>
                    <img src="/images/Holding/direktoratproduksi/DirektoratProduksi.png" alt="Logo Direktorat" class="h-8 w-8">
                </div>
            ...
            <div class="w-full max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <div class="custom-card flex flex-col items-center p-6">
                    <img src="/images/holding/direktoratproduksi/summryProduksi.png" alt="Summary Kinerja Icon" class="h-20 w-20 mb-4">
                    <h2 class="text-lg font-semibold text-gray-700">Summary Kinerja Direktorat Produksi & Pengembangan</h2>
                </div>

                <div class="custom-card flex flex-col items-center p-6">
                    <img src="/images/holding/direktoratproduksi/operasional.png" alt="operasional" class="h-20 w-20 mb-4">
                    <h2 class="text-lg font-semibold text-gray-700">Operasional DOSK & DOAT </h2>
                </div>
            </div>
