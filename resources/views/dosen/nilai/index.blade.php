...
<main class="flex-1 w-full py-10 px-4 lg:px-10">
    <div class="max-w-6xl mx-auto">
        ...
        <p class="text-sm text-slate-600 mb-6">Berikut rekap nilai praktikum yang telah diinput oleh Laboran.</p>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-4 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select id="praktikum_select" disabled class="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5 text-sm disabled:bg-slate-100 disabled:text-slate-400 outline-none">
                ...
                <div>
                    ...
                    <select id="modul_select" disabled class="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5 text-sm disabled:bg-slate-100 disabled:text-slate-400 outline-none">
