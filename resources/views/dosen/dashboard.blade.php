      ...
      <div class="max-w-3xl mx-auto px-4 relative z-10">
        ...
        <div class="text-center mb-10">
          ...
          <p class="mt-2 text-xs md:text-sm text-slate-500 max-w-xl mx-auto">
            Atur jadwal mengajar praktikum dan pantau rekap nilai mahasiswa dengan tampilan yang ringkas dan informatif.
          </p>
        </div>
          ...
          <div class="bg-white/95 rounded-[24px] px-4 sm:px-8 py-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-7 justify-items-center">
              ...
              <a href="#"
                ...
                <p class="text-sm md:text-base font-semibold text-slate-800">Rekap Nilai Praktikum</p>
                <p class="mt-1.5 text-[11px] text-slate-400 text-center">
                  Tinjau dan finalisasi nilai praktikum tiap kelas secara terstruktur.
                </p>
              </a>
