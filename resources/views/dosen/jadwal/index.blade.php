...
<body class="bg-[#f5f7fb] min-h-screen flex flex-col">
  ...
  <!-- TOP BAR (HEADER – kode tidak diubah) -->
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-3xl font-bold text-slate-900 tracking-tight">
                    Jadwal Shift Praktikum
                </h1>
                <p class="text-sm text-slate-500 mt-1">
                    Berikut daftar seluruh jadwal praktikum yang dibuat Laboran untuk Anda.
                </p>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr class="border-t border-slate-100 hover:bg-slate-50/70">
                            <td class="px-6 py-3 text-slate-800">
                                <span class="font-medium">{{ $s->praktikum }}</span>
                            </td>
