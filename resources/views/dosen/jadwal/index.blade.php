...
<head>
    <meta charset="UTF-8">
    <title>Jadwal Shift - Dosen</title>
  ...
  <main class="flex-1">
    <div class="max-w-6xl mx-auto py-10 px-4">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
                <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Jadwal Shift Praktikum</h1>
                <p class="text-sm text-slate-500 mt-1">Berikut daftar seluruh jadwal praktikum yang telah dibuat Laboran.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-100 bg-slate-50/50">
                <p class="text-xs font-bold text-slate-500 uppercase tracking-widest">Daftar Jadwal Praktikum</p>
            </div>
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody id="shift_table_body">
                        ...
                        <tr class="shift-row border-t border-slate-100 hover:bg-slate-50/80 transition" data-lab="{{ $s->lab }}">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full bg-slate-100 text-[10px] font-bold text-slate-700 border border-slate-200 uppercase">
                                    {{ $s->name }}
                                </span>
                            </td>
