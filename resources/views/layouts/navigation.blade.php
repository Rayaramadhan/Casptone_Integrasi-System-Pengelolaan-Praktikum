<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    @auth
                        @php
                            ...
                            $dashboardRoute = $isAdmin ? route('laboran.dashboard') : route('asprak.dashboard');
                        @endphp
                ...
                @auth
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="$dashRoute" :active="$isDash">
                            {{ __('Dashboard') }}
                        </x-nav-link>
    ...
    @auth
        @php
            $isAdmin        = auth()->user()->usertype === 'laboran';
            $dashRoute      = $isAdmin ? route('laboran.dashboard') : route('asprak.dashboard');
            $dashRouteCheck = $isAdmin ? 'laboran.dashboard' : 'asprak.dashboard';
        @endphp
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                {{--
                @if ($isAdmin)
                    <x-responsive-nav-link :href="route('admin.inputcatalog')" :active="request()->routeIs('admin.inputcatalog')">
                        {{ __('Catalog') }}
                    </x-responsive-nav-link>
                @else
                    <x-responsive-nav-link :href="route('user.catalog')" :active="request()->routeIs('user.catalog')">
                        {{ __('Catalog') }}
                    </x-responsive-nav-link>
                @endif
                --}}
